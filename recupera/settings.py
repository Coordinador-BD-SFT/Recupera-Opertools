"""
Django settings for recupera project.
...
# Libreria para cargar las variables de entorno
...
SECRET_KEY = 'django-insecure-xdc55t+d1dr2wgt%vg=@%6vc6m(=klcr%+emy0%u$7ip+yb83l'
...
VICIDIAL_PASSWORD = config('VICIDIAL_PASSWORD')
